...
/* 메뉴바 */
	...
	.mymenu_btn{padding:4px 18px 23px; font-size:18px; display:block; color:#a1a4a8;}
	.mymenu_btn-on{color:#FFFFFF;}
	...
	<div class="mymenu">
		<div class="mymenubar">
			<ul class="mymenu-list">
				...
				<li>
					<a href="#" title="나의 활동" class="mymenu_btn btn-mymenu-action-history mymenu_btn-on">나의 활동</a>
				</li>
				<li>
