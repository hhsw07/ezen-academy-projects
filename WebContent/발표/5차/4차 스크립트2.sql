...
'ezen05@naver.com','010-5014-1019',
...
(p5_notice_seq.nextval,'제목','내용',sysdate);
...
--공지수정
UPDATE p5_notice
SET noti_name = '세번째 공지 수정',
	noti_detail = '수정본입니다. ㅎㅎ'
WHERE noti_no = 7;
--공지삭제
DELETE FROM p5_notice
WHERE noti_no=8;
--공지상세
