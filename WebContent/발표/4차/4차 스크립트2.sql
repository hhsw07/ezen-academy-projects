...
INSERT INTO p5_order VALUES (200417||p5_order_seq.nextval,'ezen05',to_date('2020-04-17','YYYY-MM-DD'),'홍길동','010-4013-9018','01695','서울 노원구 상계로 64','화랑빌딩 7F','배송 전 연락부탁드립니다','결제완료',null);
...
INSERT INTO p5_as VALUES (p5_as_seq.nextval, 2001221001,'AS','컴퓨터가 안켜져요',to_date('2020-02-22','YYYY-MM-DD'),NULL,NULL);
INSERT INTO p5_as VALUES (p5_as_seq.nextval, 2002281003,'반품','이거 반품할래요',to_date('2020-03-02','YYYY-MM-DD'),NULL,NULL);
SELECT * FROM p5_as;
--------------------------------------
/* AS관리 */
DROP TABLE p5_mgr 
...
INSERT INTO p5_mgr VALUES (p5_mgr_seq.nextval, 1, to_date('2020-02-28','YYYY-MM-DD'), '진행상태',null,0);
SELECT * FROM p5_mgr;
--------------------------------------
--보라컴 카페에서 긁어오기(5개씩)
/* 상품후기 */
