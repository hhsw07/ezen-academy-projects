...
//    url호출 요청값?name=@@&age=@@ : get방식, 전달값 제한,
//			보안상..
//    페이지 호출하고  form method="post"   요청값 전달 body에서 전달 post방식	
...
/*
ex) login 화면을 get/post를 같이 처리하는 메서드를 선언하여.
	id/pass 인증 여부를 처리하세요..
 * */	
	...
	public String login(Member m, Model d){
		...
		return "WEB-INF\\views\\a01_basic\\a13_loginForm.jsp";
	}
