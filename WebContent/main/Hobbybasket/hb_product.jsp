...
/* 메뉴 */
	.mymenu{position:relative; width:1050px; background-color:#151515; color:#FFFFFF; font-size:18px; margin:64px auto 0; padding:30px;}
...
<!-- 소메뉴 -->
	<div class="mysubmenu">
		<nav class="mynav">
			<ul>
				<li><a href="?page=mypage_order">관심클래스</a></li>
				<li style="font-weight:bold;"><a href="?page=mypage_class">장바구니</a></li>
			</ul>
		</nav>
		<nav class="myhost">
			<ul>
