...
<section class="orderlist">
		<div style="padding-top:15px; font-size:20px; font-weight: bold;">당신만의 취미클래스로 하비팩토리와 함께하세요.</div>
		<article>
			<div class="o-info">
