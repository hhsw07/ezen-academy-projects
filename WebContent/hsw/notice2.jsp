...
<div class="all-wrap">
	...
	<!-- 글목록  -->	
	<c:forEach var="notice" items="${aslist}">
		<tr>
			<td align="center">as번호</td>
			<td>제목</td>
			<td align="center">as신청자</td>
	...
	<!-- 검색 + 글등록 -->
		<tr style="border:none;">
			<td colspan="4">
			<th><input class="reg-btn" name="regAs" type="button" value="글쓰기"/></th>
		</tr>
	</table>
	</c:if>
