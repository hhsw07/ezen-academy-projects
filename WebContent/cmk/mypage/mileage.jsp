...
/* 마일리지조회 */
	.mileage-wrap{padding:0 10%; color:#a1a4a8;}
	.mileage_page{width:1050px; margin:0 auto;}
	.reply-info-cont{padding:32px 0; margin:40px 0 0; border:5px solid #DFDFDF;}
	.reply-info-area-type02{line-height:1.71;}
	.reply-info-area{height:auto; font-size:14px; color:#a1a4a8; overflow:hidden;}
	.mileage-info{width:18%; float:left; padding:0;text-align:center;}
	.mileage-info-tit{font-size:14px; line-height:2.14;}
	.mileage-info-p{margin:2px 0; color:#2f3338; font-size:18px; line-height:1.67;}
	.mileage-info-txt{margin:10px 0 0; color:#909397; font-size:14px; line-height:1.8;}
	.mileage-cont{margin:40px 0 0;}
	.mileage-tit{padding:0 0 10px; font-size:16px; border-bottom:2px solid #3d4248; line-height:1.5; color:#3d4248;}
    .mileage-table{margin:10px 0 0; text-align:center;}
    .mileage-th{color:#2f3338; font-size:14px; border-bottom:2px solid #3d4248; line-height:2; padding-bottom:10px; text-align:center;}
    .mileage-td{padding:15px 0 18px; color:#2f3338; font-size:14px; line-height:2; vertical-align:middle; border-bottom:1px solid #dfdfdf; text-align:center;}
		...
		<article>
			<div class="mileage_page">
				...
				<div class="mileage-cont">
					<div class="mileage-tit">마일리지 적립/사용 내역</div>
					<div class="mileage-table">
						<table width="100%">
							...
							<thead>
								<tr>
									<th class="mileage-th">적립날짜</th>
									<th class="mileage-th">내역</th>
									<th class="mileage-th">마일리지</th>
								</tr>
							</thead>
							<tbody class="mileage_list_wrap">
								<tr>
									<td class="mileage-td">2020.03.04</td>
									<td class="mileage-td">주문취소(20030420-41030R0287)</td>
									<td class="mileage-td txt-color-r">+5,020p</td>
								</tr>
								<tr>
									<td class="mileage-td">2020.03.04</td>
									<td class="mileage-td">상품구매 (주문번호:20030420-41030R0287)</td>
									<td class="mileage-td">-5,020p</td>
								</tr>
								<tr>
									<td class="mileage-td">2020.01.23</td>
									<td class="mileage-td">하비팩토리 세뱃돈! 새해 취미복 많이 받으세요</td>
									<td class="mileage-td txt-color-r">+2,020p</td>
								</tr>
								<tr>
									<td class="mileage-td">2019.10.13</td>
									<td class="mileage-td">회원가입 포인트</td>
									<td class="mileage-td txt-color-r">+3,000p</td>
								</tr>
							</tbody>
						</table>
					</div>
