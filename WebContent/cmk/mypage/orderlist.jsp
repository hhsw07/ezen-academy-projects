...
/* 주문/배송 조회 */
	.orderlist{padding:30px; width:850px;}
...
<!-- 주문/배송조회 -->
	...
	Orderlist o1 = new Orderlist(2003040001, "2020.03.04", "../image/resize.jpg","고래의 꿈 네온사인", "-", 1,"배송완료");
	Orderlist o2 = new Orderlist(2003100001, "2020.03.10", "../image/lemon.jpg","상콤 레몬 수세미", "-", 1,"배송준비중");
	//olist.add(o1);
	//olist.add(o2);
	if(olist!=null){
